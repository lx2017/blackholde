...
class PictureModel extends Model
{
    ...
    public function getAdminList($where = array()){
        ...
        //查询数据
      $rows = $this->order('sort asc')->where($where)->limit($first, $pageTool->listRows)->select();
        //返回结果
     ...
     * @return bool
     */
    public function addPicture($requestData){
        ...
        if($requestData['image']){
            ...
            $rst = $uploader->moveUpload($img,'picture');
            if($rst===false){
