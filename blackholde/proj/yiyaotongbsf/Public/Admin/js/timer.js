			...
			*/
			...
			function showTimer1(tempId){
					mode[tempId+"mode"] = "HH";
					var timerConent='<table cellpadding="0" cellspacing="0" style="display:inline-block;width:160px;border:#949495 1px solid;" >'+
													'<tr style="display:inline-block;width:155px;height:25px;text-align:left;">'+
														'<td width="130" style="border:0px;display:inline-block;float:left;"><input type="text"  maxlength="2" style="position:relative;left:0px;border:0;background:transparent;width:15px;" name="HH" value="00" onchange="checkNum('+"'"+tempId+"',"+"'HH',"+'this.value)" onkeydown="keyDown('+"'"+tempId+"'"+',event.keyCode,this)" onkeyup="keyUp(event.keyCode)" onfocus="setMode('+"'"+tempId+"','HH'"+')"/><input type="text"  style="border:0;background:transparent;width:3px;" readOnly=true  value=":"/><input type="text"  maxlength="2" style="border:0;background:transparent;width:15px;" name="MM" value="00" onchange="checkNum('+"'"+tempId+"',"+"'MM',"+'this.value)" onkeydown="keyDown('+"'"+tempId+"'"+',event.keyCode,this)" onkeyup="keyUp(event.keyCode)" onfocus="setMode('+"'"+tempId+"','MM'"+')"/><input type="text"  style="border:0;background:transparent;width:6px;"  readOnly=true value=":"/><input type="text"  maxlength="2" style="border:0;background:transparent;width:15px;" name="SS" value="00" onchange="checkNum('+"'"+tempId+"',"+"'SS',"+'this.value)" onkeydown="keyDown('+"'"+tempId+"'"+',event.keyCode,this)" onkeyup="keyUp(event.keyCode)" onfocus="setMode('+"'"+tempId+"','SS'"+')"/></td>'+
														'<td width="25" style="display:inline-block;float:left;backgroud:red;border:0px;height:25px;position:relative;"><input type="button" hidefocus="true" style="position:absolute;right:0px;top:1px;border-width:2px;display:inline-block;background:url(./Public/Admin/images/up.jpg);width:15px;height:10px;" onmouseup="loopBreak()" onmousedown="loopInit('+"'"+tempId+"','+'"+')"/><input type="button" hidefocus="true" style="position:absolute;bottom:1px;right:0px;border-width:2px ;background:url(./Public/Admin/images/down.jpg);width:15px;height:10px;" onmouseup="loopBreak()" onmousedown="loopInit('+"'"+tempId+"','-'"+')"/></td>'+
													'</tr>'+
											  	'</table>';
					document.getElementById(tempId).innerHTML=timerConent;	
			}
			function showTimer2(tempId){
					mode[tempId+"mode"] = "HH";
					var timerConent='<table cellpadding="0" cellspacing="0" style="border:#949495 1px solid;table-layout : fixed" >'+
													'<tr style="width:85;height:20">'+
														'<td width="60" style="border:0px;display:block;"><input type="text"  maxlength="2" style="border:0;background:transparent;width:15;" name="HH" value="00" onchange="checkNum('+"'"+tempId+"',"+"'HH',"+'this.value)" onkeydown="keyDown('+"'"+tempId+"'"+',event.keyCode,this)" onkeyup="keyUp(event.keyCode)" onfocus="setMode('+"'"+tempId+"','HH'"+')"/><input type="text"  style="border:0;background:transparent;width:6;" readOnly=true  value=":"/><input type="text"  maxlength="2" style="border:0;background:transparent;width:15" name="MM" value="00" onchange="checkNum('+"'"+tempId+"',"+"'MM',"+'this.value)" onkeydown="keyDown('+"'"+tempId+"'"+',event.keyCode,this)" onkeyup="keyUp(event.keyCode)" onfocus="setMode('+"'"+tempId+"','MM'"+')"/></td>'+
														'<td width="20" style="border:0px;"><input type="button" hidefocus="true" style=";border-width:2px;display:block;background:url(__ROOT__/Public/Admin/images/up.jpg);width:20px;height:10px;" onmouseup="loopBreak()" onmousedown="loopInit('+"'"+tempId+"','+'"+')"/><input type="button" hidefocus="true" style="border-width:2px ;background:url(/Admin/images/down.jpg);width:20px;height:10px;" onmouseup="loopBreak()" onmousedown="loopInit('+"'"+tempId+"','-'"+')"/></td>'+
													'</tr>'+
											  	'</table>';
					document.getElementById(tempId).innerHTML=timerConent;	
			}
			function showTimer3(tempId){
					mode[tempId+"mode"] = "HH";
					var timerConent='<table cellpadding="0" cellspacing="0" style="display:inline-block;width:160px;border:#949495 1px solid;" >'+
													'<tr style="display:inline-block;width:155px;height:25px;text-align:left;">'+
														'<td width="130" style="border:0px;display:inline-block;float:left;"><input type="text"  maxlength="2" style="position:relative;left:0px;border:0;background:transparent;width:15px;" name="HH" value="00" onchange="checkNum('+"'"+tempId+"',"+"'HH',"+'this.value)" onkeydown="keyDown('+"'"+tempId+"'"+',event.keyCode,this)" onkeyup="keyUp(event.keyCode)" onfocus="setMode('+"'"+tempId+"','HH'"+')"/><input type="text"  style="border:0;background:transparent;width:3px;" readOnly=true  value=":"/><input type="text"  maxlength="2" style="border:0;background:transparent;width:15px;" name="MM" value="00" onchange="checkNum('+"'"+tempId+"',"+"'MM',"+'this.value)" onkeydown="keyDown('+"'"+tempId+"'"+',event.keyCode,this)" onkeyup="keyUp(event.keyCode)" onfocus="setMode('+"'"+tempId+"','MM'"+')"/><input type="text"  style="border:0;background:transparent;width:6px;"  readOnly=true value=":"/><input type="text"  maxlength="2" style="border:0;background:transparent;width:15px;" name="SS" value="00" onchange="checkNum('+"'"+tempId+"',"+"'SS',"+'this.value)" onkeydown="keyDown('+"'"+tempId+"'"+',event.keyCode,this)" onkeyup="keyUp(event.keyCode)" onfocus="setMode('+"'"+tempId+"','SS'"+')"/></td>'+
