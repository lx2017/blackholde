...
require_once("../src/JPush/Config.php");
...
$result = $client->push()
    ...
    ->addIosNotification("Hi, iOS notification", 'iOS sound', Config::DISABLE_BADGE, true, 'iOS category', array("key1"=>"value1", "key2"=>"value2"))
