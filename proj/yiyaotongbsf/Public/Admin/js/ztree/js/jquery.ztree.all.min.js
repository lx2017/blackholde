...
(function (q) {
    ...
    var j = {
        ...
        addNodes: function (b, a, c, d, e) {
            ...
            if (!c.isParent && a.leafIsHShow && c.level != 0) {
                b.push("<li id='", c.tId, "' class='", f.className.LEVEL, c.level, "'style='float:left;clear:none;' tabindex='0' hidefocus='true' treenode>");
            } else {
        ...
        makeNodeUrl: function (b, a) {
            ...
            if (b.leafIsHShow) {
                c.push("<ul id='", a.tId, f.id.UL, "' class='", f.className.LEVEL, a.level, " ", i.makeUlLineClass(b, a), "' style='display:", (a.open ? "block" : "none"), ";float:left'>");
