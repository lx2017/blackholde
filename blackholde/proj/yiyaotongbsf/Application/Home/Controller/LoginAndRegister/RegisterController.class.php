...
class RegisterController extends BaseController {
    ...
    public function Index()
    {
        $t=I('t');
        if($t=='wap'){
            $this->display('LoginAndRegister/register_mobile');
        }else{
            $this->display('LoginAndRegister/register');
        }
    ...
    public function YanZheng(){
        $mobile= I('mobile');
        $this->assign('mobile',$mobile);
        $this->display('LoginAndRegister/register_mobile2');
    }
    /*手机用户密码页*/
    public function RePassword(){
        $mobile =I('mobile');
        $this->assign('mobile',$mobile);
        $this->display('LoginAndRegister/register_mobile3');
    }
