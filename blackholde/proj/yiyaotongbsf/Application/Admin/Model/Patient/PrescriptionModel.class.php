...
class PrescriptionModel extends Model
{
    ...
    public function getAdminList($where = array()){
        ...
        //查询数据
        $rows = $this->alias('a')->field('a.*,b.prescription_type_name')->order('a.id desc')->where($where)->join(' LEFT JOIN __PRESCRIPTION_CATEGARY__ b on a.prescription_type_id=b.id')->limit($first, $pageTool->listRows)->select();
        //返回结果
     ...
     * @return bool
     */
    public function addPrescription($requestData){
        //创建时间
     ...
     * @return bool
     */
    public function savePrescription($requestData){
