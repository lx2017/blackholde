...
use Admin\Model\Patient\PrescriptionCategaryModel;
use Admin\Controller\AdminController;

class PrescriptionCategaryController extends AdminController{
    /**
     * 疾病库列表
     * @author jiaolele
     */
    public function index()
    {
        ...
        //查询列表信息
        $gategaryModel = new PrescriptionCategaryModel();
    ...
    public function add(){
        ...
        if(IS_POST){
            ...
            if($rst===false){
                ...
                $this->ajaxReturn(array('code'=>0,'url'=>U('index',array('key'=>'PRESCRIPTIONGATEGARYLIST'))));
            }
        }else{
            $this->display();
        }
