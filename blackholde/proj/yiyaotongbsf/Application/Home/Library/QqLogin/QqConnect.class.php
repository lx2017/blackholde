...
// +----------------------------------------------------------------------
namespace Home\Library\QqLogin;
/**
 *  qq第三方登录认证
 */
class QqConnect {
    ...
    public function __construct(){
        $this->app_id="101305567";
        $this->app_key="b4f49eae668098a9572916cb182513df";
        $this->callBackUrl="http://www.register.com/index.php/Home/LoginAndRegister/Login/QqLogin_Act";
        //检查用户数据
